...
texas_pos_data_2016_map = texas_census_data.set_index("NAME").join(
  texas_pos_data_2016_zip.set_index('zip_string'))
...
```{python}
#create list of border state prefixes and texas prefixes
border_zips = np.append(texas_zipcodes, [
  "70", "71", "72", "73", "74", "87", "880", "881", "882", "883", "884"])
...
zips_withhospital_centroids = gpd.sjoin(zips_texas_borderstates_centroids, 
  hosp_active_2016, how="inner", predicate="within")
```
